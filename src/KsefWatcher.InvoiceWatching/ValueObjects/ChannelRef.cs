...
/// e.g. a Discord channel ID, plus an optional credential, e.g. a bot token) —
/// docs/08_notification_delivery_tactical_model.md.
...
/// </summary>
public sealed record ChannelRef(string Type, string Target, string? Credential = null);
